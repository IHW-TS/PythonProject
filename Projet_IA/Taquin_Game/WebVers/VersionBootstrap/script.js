...
document.getElementById("runButton").addEventListener("click", function (event) {
    ...
    // Obtenez la taille du taquin et l'heuristique à partir des entrées utilisateur
    let size = parseInt(document.getElementById("size").value);
    let heuristic = parseInt(document.getElementById("heuristic").value);
  
    // Exécutez votre fonction de résolution de taquin ici et récupérez les résultats
    let results = solvePuzzle(size, heuristic);
  
    // Mettez à jour l'état initial et final du taquin
    document.getElementById("initialState").innerText = results.initialState;
    document.getElementById("finalState").innerText = results.finalState;
  
    // Affiche les résultats
    document.getElementById("numExplored").innerText = results.numExplored;
    document.getElementById("numMoves").innerText = results.numMoves;
    document.getElementById("heuristicSolution").innerText = results.heuristic;
    document.getElementById("executionTime").innerText = results.executionTime;
    document.getElementById("cpuTime").innerText = results.cpuTime;
  
    // Afficher les conteneurs de résultats
    document.getElementById("initialStateContainer").hidden = false;
    document.getElementById("resultsContainer").hidden = false;
    document.getElementById("finalStateContainer").hidden = false;
  
    // Créez un graphique pour afficher les résultats
